      ...
      typeList: [
        ...
        },
        {
          ...
          arr: [
            ...
            {
              name: "底部",
              type: "volume_returns_bottom",
            },
          ],
        },
        {
          name: "交易记录",
          type: "volume_valued_top",
          arr: [
            {
              name: "顶部",
              type: "volume_valued_top",
            ...
            {
              name: "底部",
              type: "volume_valued_bottom",
            },
          ],
        },
        {
          name: "交易额",
          type: "volume_valued_returns_top",
          arr: [
            {
              name: "顶部",
              type: "volume_valued_returns_top",
            ...
            {
              name: "底部",
              type: "volume_valued_returns_bottom",
            },
          ],
        },
      ],
