      ...
      typeList: [
        {
          ...
          arr: [
            ...
            {
              name: "低",
              type: "short_volume_weight_bottom",
            },
          ],
        },
        {
          name: "卖空交易量",
          type: "short_volume_top",
          arr: [
            {
              name: "高",
              type: "short_volume_top",
            ...
            {
              name: "低",
              type: "short_volume_bottom",
            },
          ],
        },
        {
          name: "卖空交易",
          type: "short_volume_valued_top",
          arr: [
            {
              name: "高",
              type: "short_volume_valued_top",
            ...
            {
              name: "低",
              type: "short_volume_valued_bottom",
            },
          ],
        },
        {
          name: "卖空余额",
          type: "short_balance_volume_top",
          arr: [
            {
              name: "高",
              type: "short_balance_volume_top",
            ...
            {
              name: "低",
              type: "short_balance_volume_bottom",
            },
          ],
        },
        {
          name: "卖空余额金额",
          type: "short_balance_volume_valued_top",
          arr: [
            {
              name: "高",
              type: "short_balance_volume_valued_top",
            ...
            {
              name: "低",
              type: "short_balance_volume_valued_bottom",
            },
          ],
        },
        {
          name: "贷款交易",
          type: "loan_transaction_volume_top",
          arr: [
            {
              name: "高",
              type: "loan_transaction_volume_top",
            ...
            {
              name: "低",
              type: "loan_transaction_volume_bottom",
            },
          ],
        },
        {
          name: "余额数量",
          type: "loan_transaction_balance_volume_top",
          arr: [
            {
              name: "高",
              type: "loan_transaction_balance_volume_top",
            ...
            {
              name: "低",
              type: "loan_transaction_balance_volume_bottom",
            },
          ],
        },
        {
          name: "贷款余额金额",
          type: "loan_transaction_balance_volume_valued_top",
          arr: [
            {
              name: "高",
              type: "loan_transaction_balance_volume_valued_top",
            ...
            {
              name: "低",
              type: "loan_transaction_balance_volume_valued_bottom",
            },
          ],
        },
      ],
